...
{
  i2c.beginTransmission(TCS34725_ADDRESS);
  i2c.write(TCS34725_COMMAND_BIT | reg);
...
uint8_t Adafruit_TCS34725::read8(uint8_t reg)
{
  ...
  i2c.requestFrom(TCS34725_ADDRESS);
  uint8_t r = i2c.readLast();
  i2c.endTransmission();
...
*/
/**************************************************************************/
Adafruit_TCS34725::Adafruit_TCS34725(SoftI2CMaster& i2c, tcs34725IntegrationTime_t it, tcs34725Gain_t gain) 
  : i2c(i2c)
{
